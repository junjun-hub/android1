...
//                Log.i("数据", uploadFileName+ "....");
                ...
                try {
                    ...
                    bitmap=PictureCompressUtil.ratio(bitmap,bitmap.getWidth()*0.8,bitmap.getHeight()*0.8);
                    fileBuf=PictureCompressUtil.Bitmap2Bytes(bitmap);
    ...
    public void photo(View view) throws Exception {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            uploadFileName=imgUri.toString();
        }
        else {
            ...
            case 1:
                ...
                if (resultCode == RESULT_OK) {
                    try {
                        ...
                        map=PictureCompressUtil.ratio(map,map.getWidth()*0.8,map.getHeight()*0.8);
                        fileBuf=PictureCompressUtil.Bitmap2Bytes(map);
        ...
        new Thread() {
            ...
            public void run() {
                ...
                RequestBody requestBody = new MultipartBody.Builder()
                        ...
                        .addFormDataPart("avatar", filename, formBody)
                        .build();
                Request request = new Request.Builder()
                        //目标的网络地址http://10.0.2.2:8000/upload
                        .url(uploadUrl)
                        .post(requestBody)
                        .build();

                try {
                    //创建一个call对象，并调用execute()方法发送请求并获取服务器返回的数据
                    Response response = client.newCall(request).execute();
                    //response.body().string()是返回数据的具体内容
